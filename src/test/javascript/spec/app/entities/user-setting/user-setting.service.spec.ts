...
describe('Service Tests', () => {
    ...
    describe('UserSetting Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(UserSettingService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/user-settings';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return UserSetting', () => {

                let entity: UserSetting;
                service.find(123).subscribe((_entity: UserSetting) => {
                    entity = _entity;
                });
